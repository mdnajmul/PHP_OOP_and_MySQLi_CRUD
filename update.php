...
<?php
   ...
   //put values inside variables which get's from text field when click 'Update' button
   ...
   if(isset($_POST['submit'])){
	   ...
	   if($name == '' || $email == '' || $skill == ''){
		   ...
		   //call 'update()' method from 'Database' class & put message inside $updateData variable
